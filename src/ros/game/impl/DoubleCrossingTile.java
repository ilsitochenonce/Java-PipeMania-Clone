...
public class DoubleCrossingTile extends Tile{
    ...
    */
    ...
    public void loadResources(ResourceManager resourceManager) {
        ...
        //Da sinistra a sopra senza attraversamenti realizzati (da sopra a sinistra con gli indici al contrario)
        frames_sinistrasopra_attraversato = new Image[Tile.NUMERO_FRAME_ANIMAZIONE];
        //Da sinistra a sotto senza attraversamenti realizzati
        frames_sinistrasotto_attraversato= new Image[Tile.NUMERO_FRAME_ANIMAZIONE];
        //Da sotto a destra senza attraversamenti realizzati
        ...
        //Da sinistra a sopra con 1 attraversamento realizzato
        frames_sinistrasopra_non_attraversato = new Image[Tile.NUMERO_FRAME_ANIMAZIONE];
        //Da sinistra a sotto con 1 attraversamento realizzato
        frames_sinistrasotto_non_attraversato = new Image[Tile.NUMERO_FRAME_ANIMAZIONE];
        //Da sotto a destra con 1 attraversamento realizzato
        ...
        for(int i=1;i<=Tile.NUMERO_FRAME_ANIMAZIONE;i++){
            ...
            frames_sottodestra_non_attraversato[i-1] = resourceManager.loadImage("caselle/ANIMATIONS/DOPPIACURVA1_DA_BOTTOM_"+i+"_0.png");
            ...
            frames_sottodestra_attraversato[i-1] = resourceManager.loadImage("caselle/ANIMATIONS/DOPPIACURVA1_DA_BOTTOM_"+i+"_1.png");
